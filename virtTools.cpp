...
void VirtTools::migrateVm(const Vm* vm, const Node* node, const string spicePort) {
	...
	unsigned long flags = VIR_MIGRATE_LIVE | VIR_MIGRATE_UNDEFINE_SOURCE | VIR_MIGRATE_PEER2PEER | VIR_MIGRATE_TUNNELLED | VIR_MIGRATE_PERSIST_DEST | VIR_MIGRATE_COMPRESSED;
